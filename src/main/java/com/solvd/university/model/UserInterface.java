...
public class UserInterface {
    ...
    private static final CourseFormatter SIMPLE_COURSE_FORMAT = course ->
        String.format("%s - %s", course.getCourseCode(), course.getCourseName());
    ...
    private void registerStudent(String firstName, String lastName, int age, String email)
        ...
        boolean isAlreadyRegistered = university
            .getStudentRegistry()
            .stream()
    ...
    private void viewEnrollmentDetails(Student student) throws StudentNotEnrolledException {
        ...
        Enrollment studentEnrollment = university
            .getEnrollments()
            .stream()
        ...
        if (payment > student.getOutstandingBalance()) {
            throw new InvalidPaymentException(
                "Payment amount ($" +
                    ...
                    String.format("%.2f", student.getOutstandingBalance()) +
    ...
    private void showAvailablePrograms(Student student) {
        Map<Department<?>, List<Program>> availablePrograms = university
            .getProgramCatalog()
            .stream()
    ...
    private void showProfessorsAndCourses() {
        ...
        Map<EnrollmentStatus, List<Student>> studentsByStatus = university
            .getStudentRegistry()
            .stream()
        ...
        Map<CourseDifficulty, List<Course<?, ?>>> coursesByDifficulty = university
            .getCourseCatalog()
            .stream()
